...
var _utilsCastValue = require('./utils/castValue');

var _utilsCastValue2 = _interopRequireDefault(_utilsCastValue);
  ...
  _createClass(Vo, [{
    ...
    value: function setData() {
      ...
      Object.keys(data).forEach(function (property) {
        _this.set(property, data[property]);
      });
      return this;
    }
  }, {
    ...
    key: 'castVoPropertyValue',
    value: function castVoPropertyValue(key, value) {
      this.constructor.assumePropertyExists(key);
      try {
        return (0, _utilsCastValue2['default'])(value, this.constructor.getPropertyConfig(key).type);
      } catch (err) {
        throw new _Errors.VoError('Cast property failed for property "' + key + '": ' + err.message);
      }
    }
  }, {
    key: '_updateStatus',
    value: function _updateStatus(newStatus) {
    ...
    key: 'statusChangeTrigger',
    value: function statusChangeTrigger(previousStatus, newStatus) {}
    // jshint ignore:line
    ...
    set: function set(value) {
      throw new _Errors.VoError('Status cannot be changed');
    }
  }], [{
    key: 'assumePropertyExists',
    value: function assumePropertyExists(property) {
      if (!this.hasProperty(property)) {
        throw new _Errors.VoError('The property ' + property + ' is not defined in ' + this.constructor.name);
      }
    }
  }, {
    key: 'hasProperty',
    ...
    key: 'getPropertiesNames',
    value: function getPropertiesNames() {
      return Object.keys(this._properties);
    }
  }, {
    key: 'getPropertyConfig',
    value: function getPropertyConfig(key) {
    ...
    value: function getPropertyDefault(key) {
      this.assumePropertyExists(key);
...
Vo.init = function (VoChild, properties) {
  ...
  Object.keys(properties).forEach(function (name) {
    ...
    var cleanedProperty = {};
    ['type', 'default'].forEach(function (elmt) {
