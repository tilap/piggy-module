...
var castValue = module.exports = function (value, type) {
  ...
  switch (type.constructor) {
    ...
    case Function:
      switch (type.name) {
        case 'Date':
          return value.constructor === Date ? value : _validator2['default'].toDate(value);
        case 'String':
          return value.constructor === String ? value : String(value);
        case 'Number':
          var v = value.constructor === Number ? value : Number(value);
          if (Number.isNaN(v)) {
