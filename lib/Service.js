...
var Service = (function () {
  ...
  _createClass(Service, [{
    ...
    key: 'setFullContext',
    value: function setFullContext(context) {
    ...
    value: function createOneFromData(data) {
      ...
      var vo = this._manager.getNewVo(data);
      return new Promise(function (resolve, reject) {
        _this._manager.saveOne(vo)['catch'](function (err) {
          return reject(err);
        }).then(function (user) {
          return resolve(user);
        });
    ...
    value: function updateOneFromData(data, id) {
      ...
      return new Promise(function (resolve, reject) {
        _this2.getOneById(id).then(function (vo) {
          if (null === vo) {
          ...
          _this2._manager.saveOne(vo).then(function (vo) {
            return resolve(vo);
          })['catch'](function (err) {
            return reject(err);
          });
