...
var Service = (function () {
  ...
  _createClass(Service, [{
    ...
    key: 'hasUserContext',
    value: function hasUserContext() {
      return this._context.user !== null;
    }
  }, {
    key: 'setAppContext',
    value: function setAppContext() {
      var app = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];

      this._context.app = app;
    }
  }, {
    key: 'hasAppContext',
    value: function hasAppContext() {
