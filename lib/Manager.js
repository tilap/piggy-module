    ...
    value: function insertOne(vo) {
      ...
      return new Promise(function (resolve, reject) {
        _this2.getAllVoErrors(vo).then(function (errors) {
          ...
          var data = [vo.data];
          _this2.storage.insert(data)['catch'](function (err) {
            throw new Error('Manager.insertOne() error: ' + err.message);
          }).then(function (newItemsData) {
            if (newItemsData.constructor !== Array || newItemsData.length !== 1) {
              return resolve(null);
            }
            resolve(_this2.getNewVo(newItemsData[0]));
          });
        })['catch'](function (err) {
    ...
    value: function updateOne(vo) {
      ...
      return new Promise(function (resolve, reject) {
        _this3.getAllVoErrors(vo).then(function (errors) {
          ...
          return _this3.storage.update(criteria, vo.data)['catch'](function (err) {
            console.log('err', err);
            throw new Error('Manager.updateOne() error: ' + err.message);
          }).then(function (affetcted) {
            console.log('nb affected', affetcted);
            return _this3.get(criteria).then(function (items) {
